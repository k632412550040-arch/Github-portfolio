  ...
  return (
    <section id="about" className="min-h-screen flex flex-col justify-center items-center px-5 sm:px-8 md:px-10 py-20 relative overflow-hidden bg-[#0C0C0C]">
      ...
      <div className="flex flex-col items-center gap-10 sm:gap-14 md:gap-16 z-10 w-full">
        ...
        <div className="flex flex-col items-center gap-16 sm:gap-20 md:gap-24 max-w-[560px]">
          <AnimatedText 
            text="With a background in International Business, I focus on marketing strategy, content planning, and community leadership. I truly enjoy working with organizations to build cohesive brand messaging and memorable events. Let's build something incredible together!"
